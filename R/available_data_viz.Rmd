...
```{r, echo = FALSE}
# get basemap
register_google("AIzaSyD3zBmW_-hDxcZuTDJ_1NRXLgkcVMHouCU")
...
flds <- ggmap(soco_basemap) + 
  ...
  geom_sf(data = floodplains, color = "dark blue", fill = "dark blue", inherit.aes = FALSE) +
  geom_sf(data = fema_100yr, color = "light blue", fill = "light blue", inherit.aes = FALSE) +
...
ggsave(filename = "flood_zones_terrain.png", plot = flds, path = here("output/maps/"), dpi = 350)
```
