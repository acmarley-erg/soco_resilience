...
Initial look at available data. Not used for any data processing.
...
# Get main town points
```{r, echo = FALSE}
sonoma_cities <- data.frame(cities = c("Petaluma, CA", "Bodega Bay, CA", "Jenner, CA 95450", 
                      "Annapolis, CA", "Cloverdale, CA", "Santa Rosa, CA", 
                      "Healdsburg, CA", "Sonoma, CA 95476"))

sonoma_city_shps <- sonoma_cities %>% 
  geocode(address = cities, 
...
ggplot() +
  geom_sf(data = soco_bound) +
  geom_sf(data = sonoma_city_shps)

write_sf(sonoma_city_shps, here("data/clean/sonoma_county_boundary/sonoma_highlight_cities.shp"))
